...
public class QuitFrame extends JFrame {
    ...
    public QuitFrame(BankDatabase atmbankDatabase) {
        super("ATM - Session ended"); //title for the frame
        ...
        dispenserPanel = slotPanelCreater("Withdraw Cash Slot", false);
